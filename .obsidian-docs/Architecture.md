...
- Consider whether execution should happen in the same container as the API, or a separate "runner" container/sidecar for isolation — see [[Security-Considerations]].
